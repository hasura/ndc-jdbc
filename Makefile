...
run-bigquery:
	OTEL_EXPORTER_OTLP_ENDPOINT=http://192.168.1.41:4317 OTEL_SERVICE_NAME=ndc-bigquery HASURA_CONNECTOR_PORT=8082 HASURA_CONFIGURATION_DIRECTORY=./configs/bigquery ./gradlew :bigquery:app:run
